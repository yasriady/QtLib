...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_DWidget_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_DWidget_t qt_meta_stringdata_DWidget = {
    {
QT_MOC_LITERAL(0, 0, 7), // "DWidget"
QT_MOC_LITERAL(1, 8, 12), // "windowLoaded"
QT_MOC_LITERAL(2, 21, 0) // ""

    },
    "DWidget\0windowLoaded\0"
};
...
void DWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        DWidget *_t = static_cast<DWidget *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject DWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_DWidget.data,
      qt_meta_data_DWidget,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *DWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_DWidget.stringdata0))
        return static_cast<void*>(const_cast< DWidget*>(this));
    if (!strcmp(_clname, "DObject"))
        return static_cast< DObject*>(const_cast< DWidget*>(this));
