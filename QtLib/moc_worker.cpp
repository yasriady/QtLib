...
#include "Testing/Thread/worker.h"
...
QT_MOC_LITERAL(5, 27, 14), // "signalProgress"
QT_MOC_LITERAL(6, 42, 3), // "str"
QT_MOC_LITERAL(7, 46, 7) // "process"

    },
    "Worker\0finished\0\0error\0err\0signalProgress\0"
    "str\0process"
};
...
void Worker::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->signalProgress((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        ...
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Worker::signalProgress)) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 2
void Worker::signalProgress(const QString & _t1)
{
    void *_a[] = { Q_NULLPTR, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
