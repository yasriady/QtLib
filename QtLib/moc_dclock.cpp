/****************************************************************************
** Meta object code from reading C++ file 'dclock.h'
**
...
#include "Clock/dclock.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'dclock.h' doesn't include <QObject>."
...
void DClock::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        DClock *_t = static_cast<DClock *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject DClock::staticMetaObject = {
    { &DLabel::staticMetaObject, qt_meta_stringdata_DClock.data,
      qt_meta_data_DClock,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *DClock::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_DClock.stringdata0))
        return static_cast<void*>(const_cast< DClock*>(this));
